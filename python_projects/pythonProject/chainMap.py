...
def get_profits(data):
    ...
    for key, value in data.items():
        print(key)
        if 'holiday' in key:
            total_holiday_profit += value
            print('th', total_holiday_profit)
        else:
            total_standard_profit += value
            print('ts', total_standard_profit)
...
# print('sp is: ', last_year_standard_profit)
# print('lp is: ', last_year_holiday_profit)

for item in new_months_data:
    profit_map = profit_map.new_child(item)

print('NEW PROFIT MAP', '\n', profit_map)

current_year_standard_profit, current_year_holiday_profit = get_profits(profit_map)

print('sp is: ', current_year_standard_profit)
print('lp is: ', current_year_holiday_profit)
